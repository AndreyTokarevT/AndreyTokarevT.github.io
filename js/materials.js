...
const MATERIALS = [
  ...
  { type: 'tests', grade: '5–7 класс', title: 'Понятие безопасности личности', text: 'Тест на проверку знаний об угрозах безопасности личности, общества и государства.', file: 'assets/maters/Test/Понятие безопасности личности.docx' },
  { type: 'tests', grade: '5–7 класс', title: 'Поведение в повседневной жизни', text: 'Тест по правилам безопасного поведения в быту и повседневной жизни.', file: 'assets/maters/Test/Поведение в повседневной жизни.docx' },
  { type: 'tests', grade: '5–7 класс', title: 'Пожарная безопасность и действия при пожаре', text: 'Проверка знаний о правилах пожарной безопасности и действиях при возгорании.', file: 'assets/maters/Test/Пожарная безопасность и действия при пожаре.docx' },
  { type: 'tests', grade: '5–7 класс', title: 'Электробезопасность', text: 'Тест по безопасному использованию электроприборов и электробезопасности.', file: 'assets/maters/Test/Электробезопасность.docx' },
  { type: 'tests', grade: '7–9 класс', title: 'Безопасность на улице и в общественных местах', text: 'Проверка знаний о правилах поведения на улице и в общественных местах.', file: 'assets/maters/Test/Безопасность на улице и в общественных местах.docx' },
  { type: 'tests', grade: '7–9 класс', title: 'Безопасность на транспорте', text: 'Тест по правилам безопасности при использовании различных видов транспорта.', file: 'assets/maters/Test/Безопасность на транспорте.docx' },
  { type: 'tests', grade: '7–9 класс', title: 'Безопасность в природной среде', text: 'Проверка знаний о правилах безопасности в походах, лесу и на природе.', file: 'assets/maters/Test/Безопасность в природной среде.docx' },
